import { Interface, BaseClass, Property, CodeGenerator, LanguageType } from '@winner-fed/nemo-engine';
 ...
 * ##                                                ##
 * ## AUTHOR: whaleFE                                ##
 * ## SOURCE: https://gitlab.hundsun.com/whaleFE/nemo ##
 * ---------------------------------------------------------------
 */
...
export default class CustomGenerator extends CodeGenerator {
  ...
  getInterfaceContent(inter: Interface) {
    ...
    const requestParams = inter.getRequestParams(this.languageType).replace(/NemoRequestParams/g, 'defs.NemoRequestParams');
   ...
   /**
     ...
     * 
     * @tags ${Array.isArray(inter.tags) && inter.tags.length && (inter.tags.join(", ")) || undefined}
     * @name ${inter.name}
     * @summary ${inter.summary}
     * @request ${method}:${inter.path}
     */
    export function request(${requestParams}) {
      return NemoCore.fetch(${url}, ${inter.getRequestContent()});
    }
   `;
  }
}
