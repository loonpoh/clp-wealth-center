...
var HttpClient = /** @class */ (function () {
    function HttpClient(apiConfig) {
        ...
        this.request = function (path, _a) { return __awaiter(_this, void 0, void 0, function () {
            var secureParams, _b, requestParams, queryString, payloadFormatter, responseFormat;
            var _this = this;
            var body = _a.body, secure = _a.secure, type = _a.type, query = _a.query, format = _a.format, baseUrl = _a.baseUrl, cancelToken = _a.cancelToken, params = __rest(_a, ["body", "secure", "type", "query", "format", "baseUrl", "cancelToken"]);
